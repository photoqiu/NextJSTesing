/*
 * @Author: ext.qiubo
 * @Date: 2021-04-14 16:31:46
 * @LastEditTime: 2021-04-14 16:38:02
 * @LastEditors: ext.qiubo
 * @FilePath: \client\src\dispatchEvent.js
 * @version:
 */
(function () {
  "use strict;";
  ...
  if (!Element.prototype.addEventListener) {
    ...
    var dispatchEvent = function dispatchEvent(event) {
      ...
      if (self.fireEvent && htmlEvents["on" + eventName]) {
        ...
        self["on" + eventName] &&
        typeof self["on" + eventName] === "function"
      ) {
      ...
      if (type == "DOMContentLoaded") {
        ...
        if (!/loaded|complete/.test(document.readyState)) {
          ...
          eventListeners.push({
            ...
            type: type,
            listener: listener,
            wrapper: documentCompleteWrapper,
          });
        }
      } else {
    ...
    var removeEventListener = function removeEventListener(
      ...
      while (counter < eventListeners.length) {
        ...
        if (
          ...
          var eventNameToDetach =
            type === "DOMContentLoaded" ? "onreadystatechange" : "on" + type;
